...
4. **사이트 로고 텍스트 변경**: "Invest Dash" → "B&K Investment" (index.html `.logo` div, 헤더 좌상단) — **아직 미반영 확인됨 (index.html:256)**
5. **PWA 사용법 확인**: 실기기에서 "홈 화면에 추가" 테스트 — 매니페스트/서비스워커는 코드로 추가했지만 실제 설치 동작은 검증 안 됨
